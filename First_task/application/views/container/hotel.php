...
<html>
    <head>
        ...
        <script>
            ...
            $('#tab_id2_length').insertAfter($("#tab_id2_info"));
            $('#tab_id2_length').show();
                                    ...
                                    <td>
                                        ...
                                        <div id="responsive2" class="modal hide fade" tabindex="-1" data-width="500">
                                            ...
                                            <center>  <div class="modal-body modal_1">
                                                    <div class="row-fluid">    
                                                        <div class="span6">   
                                                            <label class="label label-info  col-sm-2">Hotel Name</label>       

                                                            <input type="text" placeholder="Hotel_Name" class="form-control input_width">
                                                            <br/>    
                                                            <label class="label label-info  col-sm-2">Group Name</label>
                                                            <input type="text" placeholder="Group_Name" class="form-control input_width">
                                                            <br/>  
                                                            <label class="label label-info  col-sm-2">Service Name</label>  
                                                            <input type="text" placeholder="Service_Name" class="form-control input_width"> 
                                                            <br/>
                                                        </div>    
                                                    </div>   
                                                </div></center>     
